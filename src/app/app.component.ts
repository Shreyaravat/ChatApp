...
//   constructor(private webss : WebsocketService)
//   {
...
//     this.webss.message$.subscribe(message => {
//       if(message)
//       {
...
//     this.webss.connectionStatus$.subscribe(connected => {
...
//   connect()
//   {
//       console.log("Attempting to connectto websocket at http://localhost:8080/ws with username ", this.username);
//       this.webss.connect(this.username);

//       this.webss.connectionStatus$.subscribe(connected => {
//         if (connected) {
//           console.log("Connection established. Sending JOIN message.");
//           this.webss.sendMessage(this.username, 'JOIN');
//         }
//       });
//   }
...
//       if(this.message)
//       {
//         this.webss.sendMessage(this.username, this.message);
//         this.message = '';
//       }
//   }
...
//   {
//     const colors = ['#2196F3', '#32c787' , '#00BCD4', '#ffc107', '#ff85af', '#FF9800', '#39bbb0'];
//     let hash = 0;
